  ...
  const datafromapi = async () => {
    try {
      const response = await fetch(
        `https://newsapi.org/v2/top-headlines?country=${dropdown}&category=science&apiKey=0129de2ad9fa4b9aa7d99fc1faef9d5d`
      );
        ...
        {generaldata.map((values, index) => (
          <Generalcard
            ...
            image={
              values?.urlToImage
                ? values.urlToImage
                : "https://images.ctfassets.net/pc40tpn1u6ef/3A8AOys7Z2vv6dqUM486C0/77aa8f2d89b518a8ce6ea4dfca3e254d/Physics_canva.jpg?w=828&q=75"
            }
            publishdate={
