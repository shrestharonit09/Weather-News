  ...
  const datafromapi = async () => {
    try {
      const response = await fetch(
        `https://newsapi.org/v2/top-headlines?country=${dropdown}&category=general&apiKey=0129de2ad9fa4b9aa7d99fc1faef9d5d`
      );
        ...
        {generaldata.map((values, index) => (
          <Generalcard
            ...
            image={
              values?.urlToImage
                ? values.urlToImage
                : "https://jiotvimages.cdn.jio.com/dare_images/shows/700/-/2024-04-15/2404152935044.jpg"
            }
            publishdate={
